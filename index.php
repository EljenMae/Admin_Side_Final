...
<html lang="en" dir="ltr">
  <head>
    <meta charset="UTF-8">
    <title>SpyXFamily Admin Page</title>
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="#">
            ...
            <span class="links_name">Top Waiter</span>
          </a>
        </li>
        <li>
          <a href="#">
  ...
  <section class="home-section">
    <nav>
      ...
      <div class="profile-details">
        <img src="/allphotos/eljen.jpg" alt="">
        <span class="admin_name">Eljen Mae Augusto</span>
    ...
    <div class="home-content">
      ...
      <div class="sales-boxes">
        ...
        <div class="top-sales box">
          ...
          <li>
            <a href="#">
              <img src="allphoto/loid.webp" alt="">
